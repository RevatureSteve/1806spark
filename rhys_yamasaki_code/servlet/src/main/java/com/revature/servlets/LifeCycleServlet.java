...
public class LifeCycleServlet extends HttpServlet{
	 ...
	 * 							but is called at shutdown
	 * 
	 * I.Q. (shouldn't have to be asked, should be told when initially describing th init method)
	 * How can I change the default for the init() to be when the server starts instead of first request?
	 ...
	 * 		HelloWorldServlet is not so its init invoked on the first request (slower)
	 * 
	 * 
	 * I.Q.
