...
INSERT INTO ACTOR values(2,'Joe','Movie A', to_date('19960725','YYYYMMDD'),'12345 lane rd, Reston,VA 20190', 100.55,'20-AUG-16 07.17.54.098000000 PM');
INSERT INTO ACTOR values(3,'Tom','Movie A', to_date('19960725','YYYYMMDD'),'12345 lane rd, Reston,VA 20190', 100.55,'20-AUG-16 07.17.54.098000000 PM');
INSERT INTO ACTOR values(4,'Jerry','Movie B', to_date('19960725','YYYYMMDD'),'12345 lane rd, Reston,VA 20190', 100.55,'20-AUG-16 07.17.54.098000000 PM');
...
--SELECT
--select * from act_film; should proably have a table for film and then this join table 
...
FROM actor
GROUP BY ACT_NAME; -- group by used with aggregate functions IQ
...
--IQ diferent of aggregate and scalar function 
