...
public class ExcepttionsExample {
	 ...
	 *  
	 *  So, them what is the difference between a runtime error and exception?
	 *  
	 *  Exceptions: recoverable disrupt in the flow of execution ( there's something wrong when stepping through your code and can be recoverable)
	 *  Error (runtime): fatal disrupt in the flow of execution ( cannot recover from an error at runtime)
	...
	public static void main(String[] args) {
		...
		// MOST COMMON EXCEpTION! Null pointer Exception
