...
public class LifeCycleServlet extends HttpServlet {
	 ...
	 *                            
	 *  I.Q. (shouldn't have to be asked, should be told when initially describing the init method)
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		System.out.println("LifeCyle -service() called (not a business logic method)");
		/*
