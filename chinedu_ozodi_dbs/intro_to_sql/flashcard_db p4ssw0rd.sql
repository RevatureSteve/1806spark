...
INSERT INTO flash_cards(fc_question,fc_answer) VALUES ('What is the meaning of Life?', '42');
INSERT INTO flash_cards VALUES (5, 'Is theis id 5?', 'Yeeboy');
commit;
--DML select
SELECT * FROM flash_cards;
SELECT * FROM flash_cards WHERE fc_id = 1;
--SELECT requires a dummy statement so we use a fake table called dual
SELECT * FROM DUAL;
