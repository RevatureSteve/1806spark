...
public class Driver {
	 ...
	 * 		The pom file holes the meta data of the project (Data about our project)
	 * 				-name of project
	 ...
	 * 			you need right_click on project -> maven -> update project
	 * 
	 * 
	 * 		The pom.xml file replaces the .classpath
	 * 				 which is the binary version of the pom.xml file
	 * 
	 * 
	 * 
	 * 		What is the actual point of Maven... What is Maven?
	...
	public static void main(String[] args) {
		...
		//maybe start with login -- What's needed for a login
		
		//Service class for: 
		//		login()
		//		compare username input w/ usernameDb
