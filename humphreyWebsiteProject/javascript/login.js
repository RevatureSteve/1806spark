...
function changeSearch() {
    ...
    inputBoxGet.addEventListener("change", () => {
            ...
            if(document.contains(document.getElementById("loginTitle"))){
                h2 = document.getElementById("loginTitle");
                h2.innerHTML= "Search for: " + getInputValue
                h2.style.marginLeft="290px";
                }
