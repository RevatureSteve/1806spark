...
SELECT * FROM role
ORDER BY role_id;   -- to sort by a column e.g. ORDER BY col_name asc/desc
...
--We now have realtionships for actor and roles but how can we view them
