...
--DML insert
INSERT INTO flash_cards VALUES (5, 'this is 4?', 'i should be shown in Java');
...
--SELECT requiress a FROM statement so we use a fake table called dual
SELECT * FROM DUAL;
...
BEGIN
  --sysout
  DBMS_OUTPUT.PUT_LINE('hello wor1d!');
