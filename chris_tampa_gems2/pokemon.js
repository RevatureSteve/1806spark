...
window.onload = function () {
    //global scope in here that is needed to reference any html
...
function getPokemon() {
    ...
    if (pokemonNumber > 151) {
        ...
        pokemonImage.src = "https://zippy.gfycat.com/SkinnySeveralAsianlion.gif";
        //fetch thepokemon
        fetch('https://pokeapi.co/api/v2/pokemon/' + pokemonNumber)
            .then(function (response) {
                return response.json(); //reading the response and looking for just the json
