...
@Component({
  selector: 'app-employeeresolved',
  templateUrl: './employeeresolved.component.html',
  styleUrls: ['./employeeresolved.component.css']
})
...
getEmployeeResolved() {
  ...
  this.reimbursementService.employeeresolved(u_id)
