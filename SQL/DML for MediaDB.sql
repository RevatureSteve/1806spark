...
INSERT INTO actor 
VALUES(3, 'Dr.Strange', TO_DATE('19900126', 'YYYYMMDD'), 20, 'Ben', 'Cumberbatch');
INSERT INTO actor 
VALUES(4, 'Dr.Strange', TO_DATE('19900126', 'YYYYMMDD'), 20, 'Ben', 'Cumberbatch');
...
--**NOTE** what is the difference betwee truncate and delete
--Delete doesn't require a where cluase so it acts the same as a truncate
--But truncate is faster becuase it automatically commited and cannot be rolledback
...
-- add data to role table, which primarily will be lookup table
