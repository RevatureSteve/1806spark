...
public class TodoServlet extends HttpServlet{
	...
	private AppService appService = new AppService(); // available for all other methods in the future at instance level scope
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException{
		...
		//original hard coder test but gonna make them dynamic 
...
//		tasks.add(new Task(3, 3, "go for sprint", 3, "cancelled"));
		...
		//how can i get all the task from the database
		// servlet call the service, service calls the doa, dao calls the db.
		
		appService.
		
		
		/*
		 * faster.xml jackson, the standard converting
