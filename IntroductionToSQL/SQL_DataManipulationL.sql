...
--SELECT
SELECT * FROM actor;
-- SELECT * FROM actor_film; Should probably have a table for film and actor relationship join table
...
FROM actor
GROUP BY ACT_NAME; --group by keyword used with aggregate functions
