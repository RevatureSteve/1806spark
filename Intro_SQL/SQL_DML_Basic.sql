...
--SELECR * FROM actor_film;  should probably have a table for film and then this join table
...
FROM actor
GROUP BY ACT_NAME; --GROUP BY keyword: used with aggregate functions IQ
