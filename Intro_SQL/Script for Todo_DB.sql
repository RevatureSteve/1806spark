...
--Add sequence and trigger for new task
CREATE SEQUENCE task_sequence
START WITH 1
INCREMENT BY 1;

--when a user creates a new task insert a new ID from the sequence
