...
DROP USER flashcard_db CASCADE;
...
--DML insert
INSERT INTO flash_cards VALUES (4, 'this is ?', 'I should be shown in Java');
...
--Procedural Language / SQL is oracles impl of SQL
--PL/SQL sequences
...
--allowed to write PL/SQL
  ...
  END IF;
END;
/  -- / will stop code from executing further
