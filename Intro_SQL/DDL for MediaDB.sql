...
actor_id INT,
role_id INT,
--2 or more columns that will be identified as the primary key it is called a composite key
...
--FOREIGN KEY (this table's column_name) REFERENCES table_name(primary key column_name)
);