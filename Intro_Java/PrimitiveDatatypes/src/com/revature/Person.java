...
// POJO: plain old java object aka no entry point but has state and behavior
public class Person extends Object{
	...
	public Person(String name, int age, double height, boolean isAlive, char gender){
		...
		this.gender = gender;
		System.out.println("Making a person object with all parameters");
	}
	
	 /*
	  * constructors/methods with the same name but different parameters inside the same class: overloading - Interview Question IQ
	  */
	...
	public Person(String name, int age, double height){
		...
		this.age = age;
		this.height = height;
		System.out.println("Making a person object with three parameters");
	}
	...
	// method overriding: changing the implementation of a parents method: same name and same parameters IQ
