...
public class ExceptionsExample {
	 ...
	 * Error (runtime): fatal disrupt in the flow of execution e.g. of runtime errors: -
	 ...
	 * 
	 * If an exception is thrown and I don't catch it, does the code after the
	 * exception still run? NO! You must catch it to continue executing
	 * 
	 * 
	 */
