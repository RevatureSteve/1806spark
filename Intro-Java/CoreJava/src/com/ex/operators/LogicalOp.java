...
public class LogicalOp {
	public static void main(String[] args) {
		...
		System.out.println("true  && true:  " + (returnFalse() && returnTrue())); // does not need to hit to returnTrue 
		...
		System.out.println("true  || true:  " + (returnTrue() || returnFalse())); // does not need to hit the returnFalse
		System.out.println("true  || false: " + (true || false));
		System.out.println("false || true:  " + (false || true));
		System.out.println("false || false: " + (false || false));
		System.out.println();
