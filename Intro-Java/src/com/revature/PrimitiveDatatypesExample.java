...
//		primitives();
		...
		tom.name = "Tom";
		Person bobbert = new Person("Bobber", 55, 11); // another instantiated object of Person
	...
	public static void primitives() {
		...
		boolean b = true;
		boolean b1 = false;
		// range is because of memory
		// All whole number, no decimal aka no floating point
		byte t = 1; // 1 byte: -128 to 127
		short s = 3; // 2-bytes: short
		int i = -2_147_483_648; // 4-bytes: integer:
		long l = 300_000_000; // 8-bytes: long_ is to allow the number to be read easier
