...
public class Person extends Object{
		...
		public Person(){
			System.out.println("making a person object");
						...
						// when method/constructor parameters have the same name as the instance variables: shadowing 
		...
		public Person(String name, int age, double height) {
			super(); // the first line of every constructor is super() by DEFAULT!! (refers to the parent) 
			this.name = name;
			this.age = age;
			this.height = height;
		}
		...
		// method overriding: changing the implementation of a parent's method: same name and same parameters
		// note: you do not inherit constructors so you cannot override the\/		@Override //@ means annotation
