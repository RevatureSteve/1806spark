...
--SELECT * FROM actor_film; should probably have a table for film and then this join table
...
*/
DELETE FROM actor WHERE act_id = (SELECT act_id, act_address FROM actor WHERE act_name = 'Jerry' and ACT_FILM = 'Movie B');
...
SELECT a.act_name, a.act_film, ar.role_id, rt.role_type FROM actor a
