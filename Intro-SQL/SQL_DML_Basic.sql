...
--SELECT * FROM actor_film; probably have a table for actors and films 
...
FROM actor
GROUP BY ACT_NAME; -- group by key word: they are used w/ aggregate functions IQ
...
*/
--What is a difference between an angregate function and a scalar functions? 
    -- scalar functions affect each individual record
    -- aggregate functions affect a group of records
...
--Another way of learning it (but not good practice)
SELECT a.act_name, a.act_film, ar.role_id, rt.role_type
