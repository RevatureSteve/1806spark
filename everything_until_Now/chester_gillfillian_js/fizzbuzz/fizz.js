...
document.querySelector("#lookingForTex").addEventListener("change", createRandomList)

function createRandomList(){
    var dontIt = document.querySelector("lookingForTex").value;
    var someRAy = []
    for (var ran=0; ran< dontIt; ran++){
        conaole.log(" The random number is idk : " +someRAy);
