...
window.onload = () => {
    document.getElementById('username').onchange = validation;
    document.getElementById('pwd1').onchange = validation;
    document.getElementById('pwd2').onchange = validation;
}
...
function validation() {
    ...
    //http://szzljy.com/images/check/check3.jpg
...
function validUsername(username) {
    if (username != 0 && 2 < username.length && username.length < 10) {
        return true;
    }
